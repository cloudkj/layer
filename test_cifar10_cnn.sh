...
layer0="csi -script conv.scm -w test/weights.keras_cifar10_cnn.0.csv -b test/biases.keras_cifar10_cnn.0.csv --input-shape=32,32,3  --filter-shape=3,3 --num-filters=32 -a relu"
layer1="csi -script conv.scm -w test/weights.keras_cifar10_cnn.1.csv -b test/biases.keras_cifar10_cnn.1.csv --input-shape=30,30,32 --filter-shape=3,3 --num-filters=32 -a relu"
layer2="csi -script pool.scm --input-shape=28,28,32 --filter-shape=2,2 --stride=2 -p max"
...
actual0=$(cat test/cifar10_x.csv | $layer0)
...
actual1=$(cat test/cifar10_x.csv | $layer0 | $layer1)
...
actual2=$(cat test/cifar10_x.csv | $layer0 | $layer1 | $layer2)
