...
layer0="./main conv -w test/weights.keras_cifar10_cnn.0.csv -b test/biases.keras_cifar10_cnn.0.csv --input-shape=32,32,3  --filter-shape=3,3 --num-filters=32 -f relu"
layer1="./main conv -w test/weights.keras_cifar10_cnn.1.csv -b test/biases.keras_cifar10_cnn.1.csv --input-shape=30,30,32 --filter-shape=3,3 --num-filters=32 -f relu"
layer2="./main pool --input-shape=28,28,32 --filter-shape=2,2 --stride=2 -f max"
